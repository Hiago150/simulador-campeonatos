...
// ---------------- E-sports ----------------
const ESPORTS: Seed[] = [
  { id: 'navi', name: 'Natus Vincere', shortName: 'NAV', strength: 90, color: '#ffe500', region: 'emea' },
  { id: 'vitality', name: 'Team Vitality', shortName: 'VIT', strength: 91, color: '#ffd700', region: 'emea' },
  { id: 'faze', name: 'FaZe Clan', shortName: 'FAZ', strength: 88, color: '#e43d30' },
  { id: 'g2', name: 'G2 Esports', shortName: 'G2', strength: 88, color: '#ed1c24', region: 'americas' },
  ...
  { id: 'liquid', name: 'Team Liquid', shortName: 'LIQ', strength: 84, color: '#0a1a2f', region: 'emea' },
  { id: 'astralis', name: 'Astralis', shortName: 'AST', strength: 83, color: '#e30613' },
  { id: 'furia', name: 'FURIA', shortName: 'FUR', strength: 85, color: '#111111', region: 'americas' },
  { id: 'heroic', name: 'Heroic', shortName: 'HER', strength: 83, color: '#00a0e9' },
  { id: 'cloud9', name: 'Cloud9', shortName: 'C9', strength: 82, color: '#00aeef', region: 'americas' },
...
const EXTRA_ESPORTS: Seed[] = [
  { id: 'fnatic', name: 'Fnatic', shortName: 'FNC', strength: 88, color: '#ff5900', region: 'emea' },
  { id: 'sentinels', name: 'Sentinels', shortName: 'SEN', strength: 86, color: '#cd1f3c', region: 'americas' },
  { id: 'loud', name: 'LOUD', shortName: 'LLL', strength: 87, color: '#00e701', country: 'Brasil', region: 'americas' },
  { id: 'paper-rex', name: 'Paper Rex', shortName: 'PRX', strength: 86, color: '#ff1f44', region: 'pacific' },
  { id: 'drx', name: 'DRX', shortName: 'DRX', strength: 84, color: '#1f3a93', region: 'pacific' },
  { id: 'geng', name: 'Gen.G', shortName: 'GEN', strength: 86, color: '#aa8a00', region: 'pacific' },
  { id: 't1', name: 'T1', shortName: 'T1', strength: 85, color: '#e2012d', region: 'pacific' },
  { id: 'edg', name: 'EDward Gaming', shortName: 'EDG', strength: 83, color: '#cc0000', region: 'china' },
  { id: 'nrg', name: 'NRG', shortName: 'NRG', strength: 84, color: '#c8102e', region: 'americas' },
  { id: 'hundred-thieves', name: '100 Thieves', shortName: '100', strength: 82, color: '#e0162b', region: 'americas' },
  { id: 'eg', name: 'Evil Geniuses', shortName: 'EG', strength: 80, color: '#053a6a', region: 'americas' },
  { id: 'tsm', name: 'TSM', shortName: 'TSM', strength: 80, color: '#5b9bd5' },
  { id: 'karmine', name: 'Karmine Corp', shortName: 'KC', strength: 84, color: '#1f6fd0', region: 'emea' },
  { id: 'heretics', name: 'Team Heretics', shortName: 'TH', strength: 85, color: '#1a1a1a', region: 'emea' },
  { id: 'koi', name: 'KOI', shortName: 'KOI', strength: 81, color: '#00b3a4' },
  { id: 'm8', name: 'Gentle Mates', shortName: 'M8', strength: 82, color: '#ff4f8b', region: 'emea' },
  ...
  { id: 'mibr', name: 'MIBR', shortName: 'MBR', strength: 79, color: '#111111', country: 'Brasil', region: 'americas' },
  ...
  { id: 'leviatan', name: 'Leviatán', shortName: 'LVT', strength: 80, color: '#00e0c7', region: 'americas' },
  { id: 'kru', name: 'KRÜ Esports', shortName: 'KRU', strength: 79, color: '#1f1f1f', region: 'americas' },
  ...
  { id: 'eternal-fire', name: 'Eternal Fire', shortName: 'EF', strength: 81, color: '#e30613', region: 'emea' },
...
const VCT_2026: Seed[] = [
  // Americas
  { id: 'envy', name: 'Envy', shortName: 'NV', strength: 78, color: '#111111', region: 'americas' },
  // China
  { id: 'all-gamers', name: 'All Gamers', shortName: 'AG', strength: 76, color: '#0a4b9e', region: 'china' },
  { id: 'bilibili-gaming', name: 'Bilibili Gaming', shortName: 'BLG', strength: 77, color: '#fb7299', region: 'china' },
  { id: 'funplus-phoenix', name: 'FunPlus Phoenix', shortName: 'FPX', strength: 78, color: '#f36c21', region: 'china' },
  { id: 'jd-gaming', name: 'JD Gaming', shortName: 'JDG', strength: 79, color: '#e2231a', region: 'china' },
  { id: 'nova-esports', name: 'Nova Esports', shortName: 'NOVA', strength: 77, color: '#7b2cbf', region: 'china' },
  { id: 'titan-esports', name: 'Titan Esports Club', shortName: 'TEC', strength: 76, color: '#9b1212', region: 'china' },
  { id: 'trace-esports', name: 'Trace Esports', shortName: 'TE', strength: 75, color: '#00a9a5', region: 'china' },
  { id: 'tyloo', name: 'TYLOO', shortName: 'TYL', strength: 76, color: '#cc0000', region: 'china' },
  { id: 'wolves-esports', name: 'Wolves Esports', shortName: 'WOL', strength: 75, color: '#1a2f6b', region: 'china' },
  { id: 'dragon-ranger', name: 'Dragon Ranger Gaming', shortName: 'DRG', strength: 74, color: '#c8102e', region: 'china' },
  { id: 'xlg-esports', name: 'XLG Esports', shortName: 'XLG', strength: 74, color: '#1f6fd0', region: 'china' },
  // EMEA
  { id: 'bbl-esports', name: 'BBL Esports', shortName: 'BBL', strength: 78, color: '#e2231a', region: 'emea' },
  { id: 'fut-esports', name: 'FUT Esports', shortName: 'FUT', strength: 78, color: '#f5820b', region: 'emea' },
  { id: 'giantx', name: 'GIANTX', shortName: 'GX', strength: 79, color: '#0a8a4a', region: 'emea' },
  { id: 'pcific', name: 'PCIFIC Esports', shortName: 'PCI', strength: 75, color: '#00a9e0', region: 'emea' },
  // Pacific
  { id: 'detonation', name: 'DetonatioN FocusMe', shortName: 'DFM', strength: 76, color: '#f5820b', region: 'pacific' },
  { id: 'global-esports', name: 'Global Esports', shortName: 'GE', strength: 74, color: '#1a2f6b', region: 'pacific' },
  { id: 'rrq', name: 'Rex Regum Qeon', shortName: 'RRQ', strength: 79, color: '#d4af37', region: 'pacific' },
  { id: 'team-secret', name: 'Team Secret', shortName: 'TS', strength: 75, color: '#e2231a', region: 'pacific' },
  { id: 'zeta-division', name: 'ZETA DIVISION', shortName: 'ZETA', strength: 77, color: '#111111', region: 'pacific' },
  { id: 'full-sense', name: 'FULL SENSE', shortName: 'FS', strength: 76, color: '#0a4b9e', region: 'pacific' },
  { id: 'nongshim', name: 'Nongshim RedForce', shortName: 'NS', strength: 80, color: '#e2231a', region: 'pacific' },
  { id: 'varrel', name: 'VARREL', shortName: 'VRL', strength: 78, color: '#111111', region: 'pacific' }
]
